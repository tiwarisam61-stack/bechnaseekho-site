...
const CAREERSYNC_COMPANY_LINKS_MAIN = [
  ...
  { label: "Careers", to: "/careersync/jobs" as const },
                    ...
                    : col.links.map((l) => (
                      <li key={l}>
                        {l === "Find jobs" ? (
                          ...
                          <Link to="/resume-templates" className="text-sm text-ink-soft transition-colors hover:text-ink">
                            {l}
                          </Link>
                        ) : l === "ATS Score" ? (
                          <Link to="/ats-score-checker" className="text-sm text-ink-soft transition-colors hover:text-ink">
                            {l}
                          </Link>
                        ) : l === "Mock interview" ? (
                          <Link to="/careersync/journey" className="text-sm text-ink-soft transition-colors hover:text-ink">
                            {l}
                          </Link>
                        ) : l === "Courses" || l === "Certifications" ? (
                          <Link to="/careersync-academy" className="text-sm text-ink-soft transition-colors hover:text-ink">
                            {l}
                          </Link>
                        ) : (
                          <a
                            href={l === "Community" ? WHATSAPP_COMMUNITY_URL : WHATSAPP_WORKSHOPS_URL}
                            target="_blank"
                            rel="noopener noreferrer"
