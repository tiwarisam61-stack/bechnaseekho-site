...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "AI ATS Resume Score Checker | CareerSync by BechnaSeekho" },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "AI ATS Resume Score Checker | CareerSync" },
      {
    ...
    <div className="min-h-screen bg-background">
      ...
      <header className="sticky top-0 z-40 border-b border-border/60 bg-background/70 backdrop-blur-xl">
        <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-4 py-3.5 sm:px-6">
          <a href="#top" className="flex min-w-0 items-center gap-3">
            <span className="relative flex size-10 shrink-0 items-center justify-center rounded-full bg-gradient-primary text-primary-foreground shadow-[var(--shadow-glow)]">
            ...
            <span className="leading-tight">
              ...
              <span className="block text-xs font-medium text-muted-foreground">By BechnaSeekho</span>
            </span>
          </a>
      ...
      <main id="top" className="relative overflow-x-clip">
        ...
        <div className="relative z-10 mx-auto max-w-7xl space-y-20 px-4 pb-20 sm:space-y-28 sm:px-6 sm:pb-28">
          ...
          <FinalCta onUpload={uploadNow} disabled={busy || optimizing} />
        </div>
      ...
      <footer className="border-t border-border bg-card">
        <div className="mx-auto max-w-7xl px-4 py-10 text-center text-sm text-muted-foreground sm:px-6">
          <p className="font-semibold text-foreground">CareerSync by BechnaSeekho</p>
          <p className="mt-1">
            AI ATS resume intelligence · Secure, encrypted processing · Your data is never shared or
            sold.
          </p>
        </div>
      </footer>
