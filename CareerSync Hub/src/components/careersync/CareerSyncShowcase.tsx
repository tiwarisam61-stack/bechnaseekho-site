...
export function CareerSyncShowcase() {
  return (
    ...
    >
      <div
        aria-hidden="true"
        className="pointer-events-none absolute left-1/2 top-24 -z-10 h-[460px] w-[880px] -translate-x-1/2 rounded-full bg-brand-tint blur-3xl"
      />
      ...
      <div className="mx-auto w-full max-w-7xl px-4 sm:px-6">
        ...
        <div className="relative mt-14 grid items-center gap-8 sm:mt-16 lg:grid-cols-[minmax(0,1fr)_300px_minmax(0,1fr)] lg:gap-6 xl:gap-10">
