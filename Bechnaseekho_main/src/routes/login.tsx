...
import { signInWithPassword } from "@/services/platform/auth-service";
import { DEMO_ACCOUNTS } from "@/services/careersync/careersync-service";
...
function LoginPage() {
  ...
  const onGoogle = async () => {
    toast.info("Google sign-in is disabled in local-only mode.");
  };
