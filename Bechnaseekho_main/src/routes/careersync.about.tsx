          ...
          {LEADERS.map((p, i) => (
            ...
            >
              ...
              <div className="mt-6 flex items-center gap-2">
                <a href="#" className="inline-flex items-center gap-1.5 rounded-full bg-white px-3 py-1.5 text-xs font-semibold text-slate-600 ring-1 ring-slate-200 hover:text-blue-600 hover:ring-blue-200 transition">
  ...
  return (
    <footer className="border-t border-slate-200 bg-slate-950 text-slate-300">
      <div className="mx-auto grid max-w-6xl gap-10 px-4 py-16 sm:px-6 lg:grid-cols-4">
        <div>
          ...
          <div className="mt-5 flex items-center gap-2">
            {[Linkedin, Twitter, Github, Mail].map((Icon, i) => (
              <a key={i} href="#" className="grid h-9 w-9 place-items-center rounded-full bg-white/5 ring-1 ring-white/10 text-slate-300 hover:bg-white/10 hover:text-white transition">
        ...
        <FooterCol title="Company" links={[["About", "/careersync/about"], ["Blogs", "/careersync/blogs"], ["Careers", "#"], ["Press", "#"]]} />
        <FooterCol title="Product" links={[["CareerSync", "/careersync"], ["Jobs", "/careersync/jobs"], ["Resume Builder", "#"], ["Mock Interviews", "#"]]} />
